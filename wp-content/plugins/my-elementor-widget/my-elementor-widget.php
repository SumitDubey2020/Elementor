<?php
/**
 * Plugin Name:       Limitless Elementor
 * Plugin URI:        https://example.com/plugins/the-basics/
 * Description:       Handle the Testimonial with this plugin.
 * Version:           1.10.3
 * Author:            Sumit Dubey
...
final class MY_Elementor_Widget {
    ...
    */
    public function __construct() {
        ...
        add_action('elementor/editor/after_enqueue_scripts', [ $this, 'scripts_styles' ] );
    ...
    */
    public function scripts_styles() {
        ...
        wp_register_style( 'owl-carousel', MYEW_PLUGIN_URL . 'assets/css/owl.carousel.min.css', [], rand(), 'all' );
        wp_register_style( 'owl-theme', MYEW_PLUGIN_URL . 'assets/css/owl.theme.default.min.css', [], rand(), 'all' );
        wp_register_style( 'myew-style', MYEW_PLUGIN_URL . 'assets/css/public.css', [], rand(), 'all' );
        wp_register_style( 'frontend', MYEW_PLUGIN_URL . 'assets/css/frontend.css', [], rand(), 'all' );
        wp_register_script( 'owl-carousel', MYEW_PLUGIN_URL . 'assets/js/owl.carousel.min.js', [ 'jquery' ], rand(), true );
        wp_register_script( 'myew-script', MYEW_PLUGIN_URL . 'assets/js/public.js', [ 'jquery', 'swiper',], rand(), true );
        wp_register_script( 'slick', MYEW_PLUGIN_URL . 'assets/js/slick.min.js', [ 'jquery' ], rand(), true );
    ...
    */
    public function admin_notice_missing_main_plugin() {
        ...
        $message = sprintf(
            ...
            '<strong>'.esc_html__( 'Limitless Elementor', 'my-elementor-widget' ).'</strong>',
