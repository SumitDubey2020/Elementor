...
Tags: Elementor, elementor widgets, elements, elementor addons, elementor templates, elementor widgets, extensions
...
[The Plus Addons for Elementor](https://theplusaddons.com/) is made by experienced designers and developers to fulfill all your needs while developing websites. It’s completely responsive, easy to use with tons of options. Which makes this plugin the biggest, unique, and most advance. The plugin is already used by lots of designers and developers and they have given very positive feedback. We keep improving the plugin so you have the best available version with the latest features as per trends.


[Live Demo](https://theplusaddons.com/)

<h3> Reviewed by Top Youtubers</h3>

https://www.youtube.com/watch?v=kXmAQqdkVtg

<i>"This might be the only Elementor Addon you ever need" - WP Learning Lab</i>

https://www.youtube.com/watch?v=2bdeeu6sZPw

<i>"An amazing plugin,i think it is a kind of full pack addon for elementor" - GO TECH UG</i>


<h3>20+ Exclusive Elementor Widgets</h3>
1. Smooth Scroll (FREE) 
2. Full Page Scroll (FREE)
3. Hover Card (FREE)
4. Equal Height (FREE)
5. Wrapper Link (FREE)
6. Countdown (FREE)
7. Navigation Menu (FREE) 
8. Infobox (FREE)
9. Pricing Table (FREE)
10. Login/Signup (PRO)
11. Carousel Anything (PRO) 
12. Popup Builder (PRO) 
13. Mobile Menu (PRO) 
14. Cross Domain Copy Paste (PRO) 
15. FB & Google Events Tracker (PRO) 
16. White Label (PRO) 
17. Magic Scroll Integration (PRO)
18. Mega Menu (PRO) 
19. Woo Builder (PRO) 
20. Social Feed/Reviews (PRO) 
21. Draw SVG (PRO) 
22. Lottiefiles (PRO)
23. Display Rules (PRO) 
24. Custom Loop Skin (PRO) 

Check all our Widgets & Extensions in details below


<h3>30+ Free Widgets & Extensions</h3>
...
31. [Equal Height(Developer Friendly)ADVANCED](https://theplusaddons.com/plus-extras/equal-height/) - Using this option, You can setup equal height for your listing loops as well as with your standard widgets. This can be expand to long to equal height any same widgets by tracking their div structure or their common CSS class.
32. [Wrapper Link](https://theplusaddons.com/plus-extras/wrapper-link/) - You can add link on your whole section/row, Column and any widget using this option. It can be easily added and open in same tab or new tab.




<h3>65+ Pro Widgets & Extensions </h3>
...
48. [Mouse Cursor Icon](https://theplusaddons.com/plus-extras/mouse-cursor-icon-change/) - Using this widget you can change mouse cursor or icon, setup follow cursor image or you can setup text based mouse cursor style. Which help your visitors to know about any column or you can improve your UX.
49. [Column Ordering In Devices](https://theplusaddons.com/plus-extras/elementor-column-improvements-upgrades-responsive/#column-order) - Now change your column order in different devices. Best for Navigation Menus and Other Creative Layouts.
50. [Custom Media Query Breakpoints](https://theplusaddons.com/plus-extras/elementor-column-improvements-upgrades-responsive/#media-query-breakpoint) - Setup Column's Width | Margin | Padding | Visibility | Order Sequence for different breakpoints based on @Media Min/Max Width Value(You Can Add Multiple Values too using Repeater.).
51. [Column Width(Px,%,Calc())](https://theplusaddons.com/plus-extras/elementor-column-improvements-upgrades-responsive/#column-width) - Use Pixels | Percentage | Calc Function
52. [Sticky Column](https://theplusaddons.com/plus-extras/elementor-column-improvements-upgrades-responsive/#sticky-column) - Make Column Sticky based on height of other columns in row.
53. [Display/Conditional Rules](https://theplusaddons.com/plus-extras/display-rules/) - Enable/Disable your any Elementor widgets based on multiple conditions and logics, Which gives you enormous possibilities for unique and out of the box logics in Marketing or Web Management Part.
54. [Global Continuous Effects](https://theplusaddons.com/plus-extras/special-effects-parallax-3d-mouse-hover-continuous-animations-elementor-widgets/#continuous-effects) - Looking for some amazing effects for each widget? Now, You can use mouse move based parallax in elementor widgets, Special Scroll Overlay dual color effects, Tilt 3D Hover Effects, and Continuous animation effects in elementor widgets.
55. [Global Mouse Hover Parallax](https://theplusaddons.com/plus-extras/special-effects-parallax-3d-mouse-hover-continuous-animations-elementor-widgets/#mouse-parallax) - Looking for some amazing effects for each widget? Now, You can use mouse move based parallax in elementor widgets, Special Scroll Overlay dual color effects, Tilt 3D Hover Effects, and Continuous animation effects in elementor widgets.
56. [Global Special Overlay Color](https://theplusaddons.com/plus-extras/special-effects-parallax-3d-mouse-hover-continuous-animations-elementor-widgets/#first-section) - Looking for some amazing effects for each widget? Now, You can use mouse move based parallax in elementor widgets, Special Scroll Overlay dual color effects, Tilt 3D Hover Effects, and Continuous animation effects in elementor widgets.
